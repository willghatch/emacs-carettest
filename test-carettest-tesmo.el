;;; test-carettest-tesmo.el --- Tests for the carettest-tesmo testing framework -*- lexical-binding: t; -*-

;; To run these tests from the command line:
;; emacs -batch -l ert -l carettest-tesmo.el -l test-carettest-tesmo.el -f ert-run-tests-batch-and-exit

(require 'carettest-tesmo)

;;; Basic movement tests that should pass

(carettest-tesmo-test test-forward-word-basic
                      "hello <p0>world<p1> test"
                      'forward-word)

(carettest-tesmo-test test-backward-word-basic
                      "hello <p1>world<p0> test"
                      'backward-word)

(carettest-tesmo-test test-forward-char-basic
                      "hel<p0>l<p1>o world"
                      'forward-char)

(carettest-tesmo-test test-backward-char-basic
                      "hel<p1>l<p0>o world"
                      'backward-char)
(carettest-tesmo-test test-beginning-of-line
                      "<p1>hello <p0>world"
                      'beginning-of-line)
(carettest-tesmo-test test-end-of-line
                      "<p0>hello world<p1>"
                      'end-of-line)

;;; Tests with mark (region selection)

(carettest-tesmo-test test-forward-word-with-mark
                      "hello <m0><m1>world<p0> test<p1> more"
                      'forward-word)
(carettest-tesmo-test test-mark-word-simple
...
(carettest-tesmo-test test-forward-word-multiple
                      "one <p0>two three<p1> four"
                      (lambda () (forward-word 2)))
(carettest-tesmo-test test-forward-char-multiple
                      "hel<p0>lo wo<p1>rld"
                      (lambda () (forward-char 5)))

;;; Tests with setup code

(carettest-tesmo-test test-lisp-mode-forward-sexp
                      "(<p0>foo<p1> bar) (baz)"
                      'forward-sexp
                      :setup (lisp-mode))
...
(carettest-tesmo-test test-custom-markers
...
(ert-deftest test-forward-word-wrong-position ()
  ...
  (carettest-tesmo-test inner-forward-word-wrong-position
                        "hello <p0>world <p1>test"
                        'forward-word)
...
(ert-deftest test-mark-position-wrong ()
  ...
  (carettest-tesmo-test inner-mark-position-wrong
...
(carettest-tesmo-test test-empty-buffer
                      "<p0><p1>"
                      (lambda () (ignore)))  ; No-op movement

(carettest-tesmo-test test-multiline-movement
                      "first line\n<p0>second<p1> line\nthird line"
                      'forward-word)

(carettest-tesmo-test test-beginning-of-buffer
                      "<p1>hello <p0>world"
                      'beginning-of-buffer)

(carettest-tesmo-test test-end-of-buffer
                      "<p0>hello world<p1>"
                      'end-of-buffer)



;; Test the behavior of carettest-tesmo for mark end -- mark should not be active
(carettest-tesmo-test test-deactivate-mark
...
(ert-deftest test-mark-no-activate-failure ()
  ...
  (carettest-tesmo-test inner-mark-no-activate-failure
...
(carettest-tesmo-test test-transient-mark-mode-on-beginning-buffer
                      "<p1>hello <p0>world"
                      'beginning-of-buffer
...
(ert-deftest test-transient-mark-mode-off-beginning-buffer ()
  ...
  (carettest-tesmo-test inner-transient-mark-mode-off-beginning-buffer
                        "<p1>hello <p0>world"
                        'beginning-of-buffer
...
(carettest-tesmo-test test-explicit-transient-mark-on
                      "test <p0>text<p1> here"
                      'forward-word
                      :transient-mark-mode t)

(carettest-tesmo-test test-explicit-transient-mark-off
                      "test <p0>text<p1> here"
                      'forward-word
                      :transient-mark-mode nil)
...
;;; Tests for carettest-tesmo's error message format

(ert-deftest test-tesmo-point-error-message ()
  "Test that carettest-tesmo produces expected point mismatch error messages."
  (carettest-tesmo-test inner-point-test
                        "hello <p0>world <p1>test"
                        'forward-word)
...
(ert-deftest test-tesmo-mark-error-message ()
  "Test that carettest-tesmo produces expected mark mismatch error messages.
This defines an inner test that will be run and fail, and it will produce the expected message."
  (carettest-tesmo-test inner-mark-test
...
(ert-deftest test-tesmo-mark-activity-error-message ()
  "Test that carettest-tesmo produces expected mark activity error messages."
  (carettest-tesmo-test inner-mark-activity-test
                        "<p1>text <p0>here"
                        'beginning-of-buffer
                        :transient-mark-mode nil)
...
(ert-deftest test-tesmo-multiline-error-message ()
  "Test that carettest-tesmo handles multiline text in error messages correctly."
  (carettest-tesmo-test inner-multiline-test
                        "line one\nline <p0>two\nline three\nline <p1>four"
                        'forward-word)
